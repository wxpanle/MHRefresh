...
@interface QYElevenViewController ()
...
@implementation QYElevenViewController
...
//    [self timerAnimation];
    [self continuationAnimation];
}

#pragma mark - ===== 计算帧的持续时间 =====

- (void)continuationAnimation {
    ...
    _displayLink = [CADisplayLink displayLinkWithTarget:self selector:@selector(step1:)];
    [_displayLink addToRunLoop:[NSRunLoop mainRunLoop] forMode:NSDefaultRunLoopMode];
}

- (void)step1:(CADisplayLink *)displayLink {
