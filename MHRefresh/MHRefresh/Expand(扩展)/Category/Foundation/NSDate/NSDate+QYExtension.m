//
//  NSDate+QYExtension.m
//  MHRefresh
//
//  Created by developer on 2017/12/25.
//  Copyright © 2017年 developer. All rights reserved.
//

#import "NSDate+QYExtension.h"

@implementation NSDate (QYExtension)

#pragma mark - ===== Day Month Year Hour Minute Second =====

- (NSUInteger)day {
    
    return [[self class] day:self];
}

- (NSUInteger)month {
    
    return [[self class] month:self];
}

- (NSUInteger)year {
    
    return [[self class] year:self];
}

- (NSUInteger)hour {
    
    return [[self class] hour:self];
}

- (NSUInteger)minute {
    
    return [[self class] minute:self];
}

- (NSUInteger)second {
    
    return [[self class] second:self];
}
...
+ (NSUInteger)month:(NSDate *)date {
    ...
    NSCalendar *calendar = [NSCalendar currentCalendar];
    NSDateComponents *monthComponents = [calendar components:NSCalendarUnitMonth fromDate:date];
...
+ (NSUInteger)year:(NSDate *)date {
    ...
    NSCalendar *calendar = [NSCalendar currentCalendar];
    NSDateComponents *yearComponents = [calendar components:NSCalendarUnitYear fromDate:date];
...
+ (NSUInteger)hour:(NSDate *)date {
    ...
    NSCalendar *calendar = [NSCalendar currentCalendar];
    NSDateComponents *hourComponents = [calendar components:NSCalendarUnitHour fromDate:date];
...
+ (NSUInteger)minute:(NSDate *)date {
    ...
    NSCalendar *calendar = [NSCalendar currentCalendar];
    NSDateComponents *minuteComponents = [calendar components:NSCalendarUnitMinute fromDate:date];
...
+ (NSUInteger)second:(NSDate *)date {
    ...
    NSCalendar *calendar = [NSCalendar currentCalendar];
    NSDateComponents *secondComponents = [calendar components:NSCalendarUnitSecond fromDate:date];
    return secondComponents.second;
}


#pragma mark - ===== Days in year =====
...
- (NSString *)formatYMD {
    ...
    return [[self class] formatYMD:self];
}
...
- (NSUInteger)weeksOfMonth {
    ...
    return [[self class] weeksOfMonth:self];
}
...
- (NSUInteger)weekOfYear {
    ...
    return [[self class] weekOfYear:self];
}
