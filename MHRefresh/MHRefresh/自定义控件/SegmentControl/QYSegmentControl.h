...
@class QYSegmentControl;

typedef void (^IndexChangeBlock)(NSInteger index);
typedef NSAttributedString *(^HMTitleFormatterBlock)(QYSegmentControl *segmentedControl, NSString *title, NSUInteger index, BOOL selected);
...
@interface QYSegmentControl : UIView
